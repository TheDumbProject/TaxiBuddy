    ...
    <div className="container flex h-[calc(100vh-3.6rem)]  justify-center items-center ">
      <div className="h-[500px] bg-[#1e1e1e] w-[55%] border-2 border-[#C2C0C4] rounded-3xl flex items-center justify-center ">
        <div className="h-[400px] w-[90%] bg-[#444444] rounded-3xl flex items-center justify-evenly">
          ...
          <div className="right w-full flex flex-col justify-evenly item-center h-full ">
            {/* <div className="messagetitle text-3xl font-bold text-white text-center">
            ...
            <div className="text-3xl flex justify-center gap-4 ">
              ...
              <div className="text-4xl font-bold text-[#ffa800] text-center">
                Feedback
              </div>
            </div>
            <textarea
              // placeholder="Your Message"
              className="bg-[#1e1e1e] text-center rounded-2xl w-[80%] h-[60%] text-white p-4 mx-auto  resize-none"
